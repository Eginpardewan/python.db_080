...
label_nama_matkul1 = tk.Label(frame_input, text="Nama Mata kuliah Biologi: ")
...
label_nama_matkul2 = tk.Label(frame_input, text="Nama Mata kuliah Fisika: ")
label_nama_matkul2.grid(row=2, column=0, pady=10)
entry_matkul2 = tk.Entry(frame_input)
entry_matkul2.grid(row=2,column=1)

# Label Nama Mata Kuliah 3
label_nama_matkul3 = tk.Label(frame_input, text="Nama Mata kuliah Inggris: ")
label_nama_matkul3.grid(row=3, column=0, pady=10)
entry_matkul3 = tk.Entry(frame_input)
entry_matkul3.grid(row=3,column=1)
